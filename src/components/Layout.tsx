        ...
        goals.forEach(goal => {
          ...
          if (progress >= 80 && progress < 100) {
            notifications.push({
              ...
              message: `${goal.name} está em ${progress.toFixed(0)}% - Faltam apenas ${formatCurrency(goal.target_amount - goal.current_amount)}`,
              icon: Target,
              priority: 'medium',
              date: new Date(),
              actionUrl: '/goals'
          ...
          if (daysUntil <= 30 && daysUntil > 0 && progress < 50) {
            notifications.push({
              ...
              message: `${goal.name} vence em ${daysUntil} dia(s) e está em ${progress.toFixed(0)}%`,
              icon: Target,
              priority: 'medium',
              date: targetDate,
              actionUrl: '/goals'
